...
<head>
  ...
  <title>@yield('pagetitle') | Ecomshop</title>
  <!-- General CSS Files -->
...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}"> <img alt="image" src="  {{ asset('dashboard_asset/assets/img/logo.png') }}" class="header-logo" /> <span
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="{{ route('admin.createsubcategory') }}">Create Subcategory</a></li>
                <li><a class="nav-link" href="{{ route('admin.allsubcategory') }}">All SubCategory</a></li>
              </ul>
            </li>
            <li class="dropdown">
            ...
            <li class="menu-header">Product Maintance Section</li>
            <li class="dropdown">
            ...
            <li class="menu-header">Other Ssection</li>
            <li>
  ...
  <!-- Data Table -->
    ...
    <script src="{{ asset('dashboard_asset/assets/bundles/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js') }}"></script>
